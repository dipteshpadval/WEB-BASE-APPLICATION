  ...
  return (
    <div className="space-responsive">
      ...
      <div className="mb-6 sm:mb-8">
        <h1 className="text-responsive-lg font-bold text-gray-900">Dashboard</h1>
        <p className="text-responsive-sm text-gray-600 mt-1">Welcome back, {user?.email}</p>
      </div>
          ...
          <div className="card-content">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                <p className="text-responsive-sm font-medium text-gray-600">Total Files</p>
        ...
        <div className="card">
          <div className="card-content">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                <p className="text-responsive-sm font-medium text-gray-600">File Types</p>
                <p className="text-xl sm:text-2xl font-semibold text-gray-900">
        ...
        <div className="card">
          <div className="card-content">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                <p className="text-responsive-sm font-medium text-gray-600">Client Codes</p>
                <p className="text-xl sm:text-2xl font-semibold text-gray-900">
        ...
        <div className="card">
          <div className="card-content">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                <p className="text-responsive-sm font-medium text-gray-600">Asset Types</p>
                <p className="text-xl sm:text-2xl font-semibold text-gray-900">
      ...
      <div className="grid-responsive-2 mb-6 sm:mb-8">
        ...
        <div className="card">
          <div className="card-header">
            <h3 className="text-responsive-md font-semibold text-gray-900">File Type Distribution</h3>
          </div>
          <div className="card-content">
              ...
              <div className="space-y-3">
                {Object.entries(stats?.file_type_stats || stats?.file_types || {}).map(([type, count]) => (
                  <div key={type} className="flex items-center justify-between">
                    <span className="text-responsive-sm text-gray-600 truncate mr-2">{type}</span>
                    <div className="flex items-center flex-shrink-0">
                      ...
                      <span className="text-responsive-sm font-medium text-gray-900">{count as number}</span>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="card">
          <div className="card-header">
            <h3 className="text-responsive-md font-semibold text-gray-900">Recent Activity</h3>
          </div>
          <div className="card-content">
                  ...
                  <div key={file.id} className="flex items-start justify-between py-2">
                    <div className="flex items-start min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-responsive-sm font-medium text-gray-900 truncate">{file.filename}</p>
      ...
      <div className="card">
        <div className="card-header">
          <h3 className="text-responsive-md font-semibold text-gray-900">Monthly Uploads</h3>
        </div>
        <div className="card-content">
